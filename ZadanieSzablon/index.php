...
// Teraz wyświetlamy szablon z kalkulatorem
?>
<!DOCTYPE HTML>
<!--
...
<div id="wrapper" class="fade-in">
    ...
    <div id="main">
        ...
        <section class="posts">
            ...
            <!-- Drugi kafelek (z kalkulatorem) -->
             <article>
                <header>
                    <span class="date">Kalkulator</span>
                    <h2><a href="kalkulator.php">Kalkulator<br />
                    kredytowy</a></h2>
                </header>
                <a href="kalkulator.php" class="image fit"><img src="images/pic03.jpg" alt="" /></a>
                <p>Kliknij poniżej, aby przejść do kalkulatora kredytowego i obliczyć swoją miesięczną ratę.</p>
                <ul class="actions special">
                    <li><a href="kalkulator.php" class="button">Przejdź do kalkulatora</a></li>
                </ul>
            </article>
